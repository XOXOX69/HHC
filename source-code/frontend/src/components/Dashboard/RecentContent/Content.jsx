...
export default function Content({ pageConfig }) {
  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8 pb-3 animate-fadeIn'>
      <div className='w-full md:col-span-1 animate-slideInLeft' style={{animationDelay: '0.1s'}}>
        <DashboardTable
          list={PENDING}
          total={totalPending}
          loading={pendingLoading}
      ...
      <div className='w-full md:col-span-1 animate-slideInLeft' style={{animationDelay: '0.2s'}}>
        <DashboardTable
          list={RECEIVED}
          total={totalReceived}
          loading={receivedLoading}
      ...
      <div className='w-full md:col-span-1 animate-slideInLeft' style={{animationDelay: '0.3s'}}>
        <DashboardTable
          list={DELIVERED}
          total={totalDelivery}
          loading={deliveryLoading}
      ...
      <div className='w-full md:col-span-1 animate-slideInLeft' style={{animationDelay: '0.4s'}}>
        <DashboardTable
          list={saleList}
