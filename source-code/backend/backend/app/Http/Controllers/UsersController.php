...
class UsersController extends Controller
{
    ...
    {
        try {
            $user = Users::where('username', $request->input('username'))->with('role:id,name', 'store:id,name,code')->first();
            ...
            $userWithoutPassword['store'] = $user->store ? $user->store->toArray() : null;
