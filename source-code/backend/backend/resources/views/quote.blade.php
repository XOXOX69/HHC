...
<div class="wrapper">
    ...
    <div class="box5">
        <table class="table2">
            <tr>
                <th>Quote Name</th>
                <td>{{ $mailData['quoteName'] }}</td>
            </tr>
            <tr>
                <th>Quotes Owner</th>
                <td>{{$mailData['qouteOwner']}}</td>
            </tr>
            <tr>
                <th>Qoute Date</th>
                <td>{{ $mailData['qouteDate'] }}</td>
            </tr>
            <tr>
                <th>Expiration Date</th>
                <td>{{$mailData['expirationDate']}}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="box9">
        <table class="table2">
            ...
            <tr>
                <th>In Words: </th>
                <td>{{ numberToWords($mailData['totalAmount']) }}</td>
            </tr>
            <tr>
                <th>termsAndConditions: </th>
                <td>{{ $mailData['termsAndConditions'] }}</td>
            </tr>
    ...
    <div class="box12">
        <hr>
        <p>Powered by Bigstop Corporation</p>
    </div>
